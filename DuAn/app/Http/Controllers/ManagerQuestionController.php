...
class ManagerQuestionController extends Controller
{
    public function add_question(Request $request){
       ...
       // $cauhoi = cauhoi::paginate(5);
    	...
    	return view('admins.page_manager_question.add_question',['dethi'=> $dethi,'cautraloi'=>$cautraloi, 'cacdangbai'=>$cacdangbai, 'noidungkienthuc'=>$noidungkienthuc]);
    ...
    public function edit_question($question_id){
       ...
       // $theloaide = theloaide::all();
    	...
    	return view('admins.page_manager_question.edit_question',['cauhoi'=>$cauhoi,
                                                         ...
                                                         'noidungkienthuc'=>$noidungkienthuc,
                                                          'dethi'=>$dethi ]);
    }
    ...
    public function all_question(){
        ...
        // print_r($cautraloi);
        // echo "</pre>";
    	return view('admins.page_manager_question.all_question',['dethi'=> $dethi,'cautraloi'=>$cautraloi,'cauhoi'=>$cauhoi, 'cacdangbai'=>$cacdangbai, 'noidungkienthuc'=>$noidungkienthuc]);
    }
    ...
    public function search(Request $request)
    {
            ...
            //     foreach ($users as $key => $user) {
             ...
             // $output .= '</ul>';
                    if($request->get('query'))
                {
                    ...
                    {
                       $output .= '
                       <li><a href="http://localhost:81/DuAnxxx/public/search/de&keyword='.$row->tenDe.'"> '.$row->tenDe.'</a></li>
                       ';
                   }
                   $output .= '</ul>';
                   echo $output;
        ...
        // print_r($cautraloi);
        // echo "</pre>";
        return view('admins.page_manager_question.search_de',['dethi'=> $dethi,'cautraloi'=>$cautraloi,'cauhoi'=>$cauhoi, 'cacdangbai'=>$cacdangbai, 'noidungkienthuc'=>$noidungkienthuc, 'mes'=>$messenger]);
